...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE job_post SET jobtitle='$companyname', experience='$role', minimumsalary='$CTC', qualification='$qualification', minimummarks='$Eligibility',  description='$description' where id_jobpost='$_SESSION[id_jobpost] '";

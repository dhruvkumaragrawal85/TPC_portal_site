...
<body style="background-color:#a8d3ff">
            ...
            <div class="container">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
                        <div class="img">
                            <img src="assets/img/sideimg.png" alt="" class="img-fluid">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row gy-4">
                            <div class="col-lg-8 order-2 order-lg-1"  data-aos-delay="100">
                                <h3>Objectives</h3>
                                <p class="fst-itali">
                            ...
                            <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos-delay="200">
                                <img src="assets/img/objectives.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div> -->
                    <!-- End Tab Content -->

 <img src="assets/img/iitp.svg" height="140px" style="height:140px" />
     ...
     <div class="container-fluid d-flex align-items-center justify-content-between">
         ...
         <nav id="navbar" class="navbar">
             <ul>
                 ...
                 <li class="dropdown"><a class="nav-link scrollto" href="index.php"><span>Login</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>

                         <li><a href="admin/index.php">Admin Login</a></li>
                         <li><a href="login-candidates.php">Student Login</a></li>
                         <li><a href="login-company.php">Placement Cell</a></li>
                         <li><a href="login-alumni.php">Alumn Login</a></li>


                     </ul>
                 </li>
                 <li class="dropdown"><a class="nav-link scrollto" href="index.php"><span>Register</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>

                         <!-- <li><a href="admin/index.php">Admin</a></li> -->
                         <li><a href="register-candidates.php">Students</a></li>
                         <li><a href="register-company.php">Placement Cell</a></li>
                         <li><a href="register-alumni.php">Alumni</a></li>

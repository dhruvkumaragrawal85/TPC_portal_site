...
if(isset($_GET['filter']) && $_GET['filter']=='city') {
      ...
      $sql1 = "SELECT * FROM job_post WHERE id_company>='$row1[id_company]' LIMIT $start_from, $limit";
         ...
         <div class="attachment-block clearfix">
                ...
                <div class="attachment-pushed">
                  <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">$<?php echo $row['minimummarks']; ?>/Month</span></h4>
  ...
  // searches jobs on the basis of name of company, used in Student login -> Active Drive Section

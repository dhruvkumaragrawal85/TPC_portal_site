...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box hello">
    <div class="login-logo ">
      ...
      <a href="index.php" style="color:black"><b>Alumni Portal</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body bg-blue-200 text-black ">
      <p class="login-box-msg text-2xl text-black">Alumni Login</p>

      <form method="post" action="checklogin-alumni.php " class="text-xl">
        <div class="form-group has-feedback">
          <input type="email" id="large" class="form-control" id="email" name="alumni_email" placeholder="Email">
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="password" id="large" class="form-control" id="password" name="alumni_password" placeholder="Password">
    ...
    <a class="text-xl text-black" href="register-alumni.php">Create new account</a>
    <!-- /.login-box-body -->
  </div>
  <!-- /.login-box -->
